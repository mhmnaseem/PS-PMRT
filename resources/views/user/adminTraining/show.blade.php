                            ...
                            <div class="col-sm-4">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <p class="text-muted">{{$adminTraining->start_date->format(config('constants.time.format'))}}</p>
                                        ...
                                        <p class="text-muted">
                                            {!! timeSpent($adminTraining->start_date,$adminTraining->end_date) !!}
                                        </p>
