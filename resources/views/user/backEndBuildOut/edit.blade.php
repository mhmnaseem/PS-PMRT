                                ...
                                <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker" name="start_date" data-start-date="{{$backEndBuildOut->start_date}}"  value="{{ old('start_date',$backEndBuildOut->start_date) }}" required autofocus>
                                        </div>
                                        <!-- /.input group -->
                                ...
                                <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker1" name="end_date" data-end-date="{{$backEndBuildOut->end_date}}"  value="{{ old('end_date',$backEndBuildOut->end_date) }}" autofocus>
                                        </div>
                                        <!-- /.input group -->
