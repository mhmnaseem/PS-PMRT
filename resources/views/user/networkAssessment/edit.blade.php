...
@section ('main-content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Network Assessment Update

            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Project</a></li>
                <li class="active">Network Assessment Update</li>
            </ol>
        </section>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" list="title_hint" id="title" class="form-control" name="title"  value="{{ old('title',$networkAssessment->title) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker" name="start_date" data-start-date="{{$networkAssessment->start_date}}"  value="{{ old('start_date',$networkAssessment->start_date) }}" required autofocus>
                                        </div>
                                        <!-- /.input group -->
                                ...
                                <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker1" name="end_date" data-end-date="{{$networkAssessment->end_date}}"  value="{{ old('end_date',$networkAssessment->end_date) }}" autofocus>
                                        </div>
                                        <!-- /.input group -->
