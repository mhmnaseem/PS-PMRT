            ...
            <div class="row">
                ...
                <!-- general form elements -->
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" role="form" method="post" action="{{route('pm.update',$pm->slug)}}">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            <div class="box-body">

                                <input type="hidden" name="id" value="{{ old('id',$pm->id) }}">
                            ...
                            <div class="box-footer">
                                ...
                                <a class="btn btn-warning" href="{{route('pm.index')}}"> Back </a>
                            </div>
                        </form>
                    </div>
                    <!-- /.box -->
